...
const Coment = (props) => {
   ...
   const submitComent= async (event)=>{
       ...
       const dataComents={
        ...
        await axios.post("https://itinerario-app.herokuapp.com/api/coments",{dataComents})
        .then(response => 
        ...
        useEffect(() => {
          ...
          axios.get(`https://itinerario-app.herokuapp.com/api/coments/${id}`)
            .then(response =>{
                setComment(response.data.response.comentario)
        ...
        const borrarComentarios =async(id) =>{
          ...
          await  axios.delete(`https://itinerario-app.herokuapp.com/api/coments/${id}`)
            setReload(!reload)
        }
        ...
        const editar = async(id) =>{
            let data=cambio           
          await  axios.put(`https://itinerario-app.herokuapp.com/api/coments/${id}`,{data})
